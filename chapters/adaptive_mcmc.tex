...
\begin{assumption}[Iterative algorithm]
   \label{a:markov}
...
We now make an assumption on smoothness w.r.t. parameter $\gamma$. For this purpose, we denote the metric on $\mathcal{I}$ as $\tilde{d}$.
...
\begin{proof}
    ...
    % By monothone convergence there exits a pointwise limit $Y_{\infty} \in [0, \infty]$.
