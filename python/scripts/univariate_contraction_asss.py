...
from kernels_ import ASSS, ASSSAdaptState
...
kernel_normal = ASSS(potential_fn=potential_fn)
...
kernel_mixture = ASSS(potential_fn=potential_fn)
...
run_kernel(kernel_normal, svg_out_name="asss-univariate-contraction-decrease-dual.svg")
run_kernel(kernel_mixture, svg_out_name="asss-mixture-contraction-decrease-dual.svg")